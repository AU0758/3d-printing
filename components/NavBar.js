...
const NavBar = () => {
  return (
    <nav className='flex sticky justify-between top-0 p-5 bg-[#FFF9] text-gray-700 font-extrabold backdrop-blur-xl shadow-md'>
        <div>
